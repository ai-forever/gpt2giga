...
- **Task tracking:** When executing work from a task-breakdown or handoff document, keep the task status updated in that source document and preserve the one-task-per-commit rule.
