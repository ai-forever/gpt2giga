...
Legacy product data is not part of these gateway manifests. Follow the separate
[migration and legacy guidance](gigaloom-migration.md) before changing or
removing data owned by a split-out product.
