...
### Fixed
- **Parallel function calls in the GigaChat v2 SDK**: the refreshed vendored `gigachat==0.2.4a1` wheel serializes `model_options.parallel_tool_calls` and preserves each returned `function_call` `id`. The legacy v1 contract is unchanged.
