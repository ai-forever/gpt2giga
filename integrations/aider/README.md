...
Корневой `http://localhost:8090` следует `GPT2GIGA_GIGACHAT_API_MODE=v1|v2`.
Если нужен явный backend contract, используйте `http://localhost:8090/v1`
для GigaChat v1 или `http://localhost:8090/v2` для GigaChat v2.
