...
COPY gigachat-0.2.3a1-py3-none-any.whl ./
...
COPY gigachat-0.2.3a1-py3-none-any.whl /tmp/gigachat-0.2.3a1-py3-none-any.whl

RUN python -m venv "$VIRTUAL_ENV" \
    && pip install --no-cache-dir /tmp/gigachat-0.2.3a1-py3-none-any.whl \
