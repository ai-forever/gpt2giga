...
После последнего рефакторинга `/admin` переведён на модульный TypeScript frontend с раздачей статических ассетов из optional UI package.
...
- [gpt2giga/frontend/admin/utils.ts](./gpt2giga/frontend/admin/utils.ts)
...
- [packages/gpt2giga-ui/src/gpt2giga_ui/static/admin/console.css](./packages/gpt2giga-ui/src/gpt2giga_ui/static/admin/console.css)
- [packages/gpt2giga-ui/src/gpt2giga_ui/static/admin/index.js](./packages/gpt2giga-ui/src/gpt2giga_ui/static/admin/index.js)

Что изменилось:

- браузер теперь грузит UI как нормальные статические ассеты
- shipped ассеты живут в optional package `gpt2giga_ui`, который реально подхватывает runtime
...
Этот шаг компилирует `gpt2giga/frontend/admin/**/*.ts` сразу в `packages/gpt2giga-ui/src/gpt2giga_ui/static/admin/**/*.js`.
...
- [gpt2giga/core/config/control_plane.py](./gpt2giga/core/config/control_plane.py)
- [gpt2giga/api/admin/settings.py](./gpt2giga/api/admin/settings.py)
- [gpt2giga/api/admin/access.py](./gpt2giga/api/admin/access.py)
...
- [gpt2giga/api/admin/runtime.py](./gpt2giga/api/admin/runtime.py)
- [gpt2giga/api/admin/logs.py](./gpt2giga/api/admin/logs.py)
...
Backlog из [UI_PARALLEL_TASKS.md](./UI_PARALLEL_TASKS.md) считается завершённым полностью.
