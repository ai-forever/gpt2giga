...
import { card, kpi, pill, renderDefinitionList, renderGuideLinks, renderPageFrame, renderPageSection, renderTable, renderWorkflowCard, } from "../templates.js";
    ...
    app.setContent(renderPageFrame({
        ...
        sections: [
            renderPageSection({
                ...
                description: "Keep the first screen summary-first: current posture on the left, next operator handoffs on the right.",
          ...
          `,
            ...
            renderPageSection({
                ...
                description: "Keep failures visible on the same screen as the operator playbook that explains where to drill next.",
                bodyClassName: "page-grid",
                body: `
