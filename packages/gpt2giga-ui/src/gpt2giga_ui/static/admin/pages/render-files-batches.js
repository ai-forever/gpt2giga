...
import { buildFilesBatchesInventory, readFilesBatchesFilters, } from "./files-batches/serializers.js";
...
export async function renderFilesBatches(app, token) {
    ...
    const page = currentPage === "files" || currentPage === "batches" ? currentPage : "files-batches";
    ...
    app.setContent(`
    ${card("Workbench navigation", renderSubpageNav({
        currentPage: page,
