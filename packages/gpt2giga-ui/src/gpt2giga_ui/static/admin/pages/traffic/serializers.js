...
export function readTrafficFilters() {
...
export function buildUsageKeysQuery(filters) {
    const params = new URLSearchParams();
    params.set("limit", filters.limit || DEFAULT_LIMIT);
    setQueryParamIfPresent(params, "provider", filters.provider);
    setQueryParamIfPresent(params, "model", filters.model);
...
export function buildUsageProvidersQuery(filters) {
    const params = new URLSearchParams();
    params.set("limit", filters.limit || DEFAULT_LIMIT);
    setQueryParamIfPresent(params, "provider", filters.provider);
    setQueryParamIfPresent(params, "model", filters.model);
...
export function buildTrafficScopeSummary(filters, requestEvents, errorEvents, providerEntries, providerSummary) {
...
export function buildTrafficSelectionSummary(filters) {
    return [
...
export function buildTrafficEventSelectionSummary(kind, item, counterpart) {
...
export function buildUsageSelectionSummary(kind, item, filters) {
    return [
        {
            label: "Selection",
...
export function summarizeTrafficFilters(filters) {
    return [
...
export function renderStatusSummary(event) {
...
export function joinObjectKeys(value) {
...
export function summarizeRouteStatus(event) {
...
export function renderUsageProviderRows(entries) {
    return renderTable([
        { label: "Provider" },
        { label: "Traffic" },
        { label: "Tokens" },
...
export function seedTrafficSelection(filters, requestLookup, errorLookup, selectTrafficEvent) {
    if (!filters.requestId) {
        return;
    }
