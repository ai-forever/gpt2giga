...
import { buildLogsUrlForRequest, buildTrafficScopeSummary, buildTrafficUrl, renderErrorRows, renderRequestRows, renderUsageKeyRows, renderUsageProviderRows, } from "./serializers.js";
import { renderErrorPreviewRows, renderRequestPreviewRows, renderTrafficInspector, renderTrafficOverviewAside, renderTrafficPreviewLane, renderUsagePreviewRows, } from "./view-helpers.js";
...
function renderTrafficOverviewPage(data, filters, requestPinned) {
    ...
    ${card("Scope and next move", renderTrafficOverviewAside({
        errorEvents: data.errorEvents,
        filters,
        keyEntryCount: data.keyEntries.length,
        providerEntryCount: data.providerEntries.length,
        requestPinned,
