...
_ROOT_COMMANDS = (
    "agent chat completion config doctor eval harness init integration memory "
...
complete -c giga -f -n '__fish_use_subcommand' -a 'agent chat completion config doctor eval harness init integration memory native open preset project provider run runtime schedule session state tui ui worker workflow codex claude gemini'
