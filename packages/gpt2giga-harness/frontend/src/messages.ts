...
const catalogs = {
  en: {
    ...
    shellNotice:
      "Settings remain presentation-only. Open the legacy cockpit for authoritative runtime configuration.",
  ...
  ru: {
    ...
    shellNotice:
      "Настройки остаются presentation-only. Для authoritative runtime configuration откройте legacy cockpit.",
    verticalMigrationNotice:
