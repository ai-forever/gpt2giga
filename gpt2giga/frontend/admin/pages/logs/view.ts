    ...
    ${card(
      ...
      renderGuideLinks(
        ...
        filters.requestId
          ...
          : "Logs stays request-scoped. Use the guides when the current posture and tail context are still not enough to choose the next handoff.",
      ),
      "panel panel--span-4 panel--aside",
    )}
        ...
        <div class="workflow-card__header">
          ...
          <p>${escapeHtml(
            scoped
              ...
              : "Logs is the deep-dive surface. Start from Traffic summaries when possible, then land here only after one request, failure, or text pattern is worth tracing line by line.",
          )}</p>
        </div>
