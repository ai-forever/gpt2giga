  ...
  app.setContent(
    renderPageFrame({
      ...
      sections: [
        renderPageSection({
          eyebrow: "Dashboard",
          title: "Gateway status and next surface",
          description:
            "Keep the first screen summary-first: current posture on the left, next operator handoffs on the right.",
        ...
        renderPageSection({
          eyebrow: "Monitor",
          title: "Recent issues and escalation guides",
          description:
            "Keep failures visible on the same screen as the operator playbook that explains where to drill next.",
          bodyClassName: "page-grid",
          body: `
            ${card(
