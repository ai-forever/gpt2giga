...
from gpt2giga.harness.agents import agent_profile_to_dict, load_agent_profile
...
from gpt2giga.harness.sessions.store import title_from_prompt
...
class ScheduleService:
    ...
    def _sync_occurrences(self) -> None:
        ...
        from gpt2giga.harness.runtime.models import TERMINAL_JOB_STATUSES
